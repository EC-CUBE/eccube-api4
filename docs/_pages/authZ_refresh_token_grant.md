---
permalink: /authZ_refresh_token_grant
---
## Refresh Token Flow での認可

[Authorization Code Flow](authZ_code_grant) で取得したアクセストークンの有効期限が切れたときは、リフレッシュトークンを使用して新しいアクセストークンを発行します。
